...
export default function Home() {
  return (
    <div id="start" className="overflow-hidden">
      <Header></Header>
      <main className="flex flex-col items-center justify-center text-center p-10">
        ...
        Nossa empresa, AutoScan, é uma afiliada à Porto Seguro que utiliza inteligência artificial para oferecer um atendimento ao cliente eficiente e inovador. Nossa plataforma otimiza a comunicação, proporcionando respostas rápidas e soluções práticas, garantindo a satisfação dos usuários e simplificando processos.
        </p>
        <button 
              className="bg-[#605EDB] text-white py-2 px-4 rounded-3xl w-40 h-12
              hover:bg-[#4d4ab6] transition duration-1000 hover:scale-110">
                <a className="text-3xl font-bebas"
                href="#contact">Contato</a>
              </button>
        <section className="mt-20 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex-1">
              <h2 className="text-4xl font-bold text-black mb-6">Atendimento Online</h2>
              ...
              <button 
              className="bg-[#605EDB] text-white py-2 px-4 rounded-3xl w-60 h-12
              hover:bg-[#4d4ab6] transition duration-1000 hover:scale-110">
                <Link className="text-4xl font-bebas"
                href="/auth/registro">Registrar-se!</Link>
              </button>
            </div>
            <div className="flex-1">
              <img 
        ...
        <section className="mt-20 max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6">Nossos Serviços</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border rounded-lg p-6 hover:shadow-lg transition duration-1000 hover:scale-110">
              <h3 className="text-xl font-semibold mb-2">Consultoria Técnica</h3>
              <p className="text-gray-700">Oferecemos consultoria via IA para otimizar seus processos e aumentar a eficiência.</p>
            </div>
            <div className="border rounded-lg p-6 hover:shadow-lg transition duration-1000 hover:scale-110">
        ...
        <section className="mt-20 max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-black mb-6">O que nossos clientes dizem</h2>
          <div className="flex flex-col space-y-4">
            <blockquote className="border-l-4 border-[#605EDB] pl-4 italic">
              "A AutoScan transformou a maneira como trabalhamos! O suporte online é excepcional."
        ...
        <h2 className="text-3xl font-bold text-black mt-20">Entre em Contato</h2>
        <section id="contact" 
        className="w-screen flex justify-evenly items-center">
          <form className="bg-gray-100 p-6 h-full w-1/3 rounded-lg">
            <div className="flex flex-col space-y-4">
